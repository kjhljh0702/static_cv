...
- Actual Java Edition 1.20.1 textures: files listed in `source-manifest.json` include original item sprites, GUI atlases, the title panorama face, and Steve skin. Download source: https://github.com/InventivetalentDev/minecraft-assets/tree/1.20.1/assets/minecraft/textures. Each source URL and SHA-256 is recorded in the manifest; `scripts/fetch-minecraft-assets.py` reproduces the downloads.
